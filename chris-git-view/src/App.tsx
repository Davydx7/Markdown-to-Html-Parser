...
function App(): JSX.Element {
  ...
  useEffect(() => {
    if (ref.current !== null) {
      const ui = new Diff2HtmlUI(ref.current, Diffed.repeat(3), {
        matching: 'lines',
  ...
  const Diffed = createPatch('fileName', oldString, newString, 'oldHeader', 'newHeader');
  console.log(Diffed);

  const mergeResult = applyPatch(oldString, Diffed);
